...
\begin{longtable}{|>{\centering\arraybackslash\small}p{2.2cm}|>{\centering\arraybackslash\small}p{0.9cm}|>{\small}p{7.4cm}|>{\centering\arraybackslash\small}p{1.3cm}|>{\centering\arraybackslash\small}p{0.6cm}|}
  ...
  \cellcolor{featProduct} & US41 & As a customer, I want to see on a product page a cheaper offer for the same item and relevant alternatives across stores so that I can compare and avoid overpaying. & \cellcolor{moscowCould}\textbf{Could} & \cellcolor{complexHigh}\textbf{3} \\\hline
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{|l|l|>{\raggedright\arraybackslash}p{2.9cm}|X|>{\centering\arraybackslash}p{1.7cm}|}
    ...
    \cline{2-5}
      & Sprint 2 & Store and product management & US05 store creation, US06 readable store slug, US07 storefront WYSIWYG editor, US08 style presets, US09 multiple stores (premium), US10 product CRUD, US11 product images, US12 product tags, US13 category browsing, US34 store-wide sales & \textasciitilde1.5 months \\
    \hline
