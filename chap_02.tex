...
The product backlog comprises \textbf{36 user stories} across
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{|l|l|X|>{\centering\arraybackslash}p{2.9cm}|}
    ...
    \multirow{2}{*}{\textbf{Release 2}}
      & Sprint 3 & Orders, payment and administration & US14--US17, US19--US21, US36 \\
    \cline{2-4}
...
product backlog of 36 user stories across 8 features, and the planning
