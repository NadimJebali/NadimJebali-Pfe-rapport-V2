...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{|l|X|}
    ...
    \hline
    Store and product verification & Multimodal LLM (Google Gemini) screening images and listing text \\ \hline
    AI storefront redesign         & Groq \texttt{llama-3.3-70b-versatile} generating the storefront customisation \\ \hline
...
\begin{table}[H]
  ...
  \begin{tabular}{|>{\centering\arraybackslash}m{1.4cm}|l|m{8.2cm}|}
    ...
    \hline
    \includegraphics[height=0.8cm]{img/github.png}    & GitHub    & Version control, pull-request review and CI/CD via GitHub Actions. \\ \hline
    \includegraphics[height=0.8cm]{img/notion.png}    & Notion    & Backlog management, task board and record of user stories. \\ \hline
    \includegraphics[height=0.8cm]{img/vscode.png}    & VS Code   & Primary IDE, extended for TypeScript, Prisma, ESLint and Git. \\ \hline
    \includegraphics[height=0.8cm]{img/docker.png}    & Docker    & Containerisation of all services for dev/prod parity. \\ \hline
    \includegraphics[height=0.8cm]{img/terraform.png} & Terraform & Infrastructure-as-code provisioning of the DigitalOcean resources. \\ \hline
    \includegraphics[height=0.8cm]{img/n8n.png}       & n8n       & Visual workflow automation orchestrating the AI features. \\ \hline
    \includegraphics[height=0.8cm]{img/postman.png}   & Postman   & Manual testing and documentation of the REST endpoints. \\ \hline
    \includegraphics[height=0.8cm]{img/pnpm.png}      & pnpm      & Fast, disk-efficient package manager for the monorepo. \\ \hline
  \end{tabular}
\end{table}
