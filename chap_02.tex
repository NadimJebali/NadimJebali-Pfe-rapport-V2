...
\begin{enumerate}[label=\textbf{FR-PS\arabic*.},leftmargin=*,itemsep=1pt]
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{|l|l|X|>{\centering\arraybackslash}p{2.9cm}|}
    ...
    \cline{2-4}
      & Sprint 4 & AI verification, product suggestions, premium tier, theming and DevOps & US22--US33, US35, US40, US41 \\
    \hline
  \end{tabularx}
