...
\begin{longtable}{|>{\centering\arraybackslash\small}p{2.2cm}|>{\centering\arraybackslash\small}p{0.9cm}|>{\small}p{7.4cm}|>{\centering\arraybackslash\small}p{1.3cm}|>{\centering\arraybackslash\small}p{0.6cm}|}
  ...
  & US10 & As a seller, I want to create, edit and delete products so that I can keep my catalogue up to date. & \cellcolor{moscowMust}\textbf{Must} & \cellcolor{complexMed}\textbf{2} \\\cline{2-5}
  ...
  & US38 & As a user, I want to view and edit my profile and change my password so that I can keep my account details current and secure. & \cellcolor{moscowMust}\textbf{Must} & \cellcolor{complexMed}\textbf{2} \\\cline{2-5}
...
The product backlog comprises \textbf{41 user stories} across
...
product backlog of 41 user stories across 10 features, and the planning
