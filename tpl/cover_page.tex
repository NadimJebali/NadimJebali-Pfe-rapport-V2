...
\vspace{1.5mm}
\textbf{{Higher Private School of Engineering and Technology}}\\
\vspace{1.5mm}
\textbf{{TEK-UP}}\\
\vspace{1.5mm}
\end{minipage}
...
{\textbf{Submitted in fulfilment of the requirements for the}}\\
\vskip2mm
{\textbf{\@diplomaName}}\\
...
\begin{center}
\large
\begin{tabular}{@{}>{\raggedright\arraybackslash}p{0.30\columnwidth}>{\raggedright\arraybackslash}p{0.42\columnwidth}>{\raggedright\arraybackslash}p{0.22\columnwidth}@{}}
Professional Supervisor: & \textbf{\@proFramerName}      & \@proFramerSpeciality      \\[3mm]
